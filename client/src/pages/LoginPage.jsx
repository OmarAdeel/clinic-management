...
const DEMO_ACCOUNTS = [
  { role: 'admin', email: 'admin@clinic.test' },
  { role: 'doctor', email: 'dr.ahmed@clinic.test' },
  { role: 'receptionist', email: 'reception@clinic.test' },
  { role: 'patient', email: 'sara.patient@clinic.test' },
]
